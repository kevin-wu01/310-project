...
exports.getInvalidTransformation = void 0;
const query1 = {
    WHERE: {
        AND: [
            {
...
function getInvalidTransformation() {
    let query = query1;
    let resultObject = resultObject1;
    return ({ query, path: "courses.zip", resultObject });
}
exports.getInvalidTransformation = getInvalidTransformation;
//# sourceMappingURL=TransformQueryTestUtil.js.map