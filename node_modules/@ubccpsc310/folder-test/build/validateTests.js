...
var legalKeys = new Set(["title", "input", "errorExpected", "verbose", "with", "filename"]);
    ...
    try {
        for (var maybeTests_1 = __values(maybeTests), maybeTests_1_1 = maybeTests_1.next(); !maybeTests_1_1.done; maybeTests_1_1 = maybeTests_1.next()) {
            ...
            try {
                ...
                Log_1.default.error(maybeTest.filename + " does not conform to the test schema. (" + err.message + ")");
                badTests++;
            }
        }
    }
